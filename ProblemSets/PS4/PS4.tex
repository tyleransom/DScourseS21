...
\pagestyle{head}
\firstpageheader{\textbf{\class\ - \term}}{\textbf{\examnum}}{\textbf{Due: Feb. 25\\ beginning of class}}
\runningheader{\textbf{\class\ - \term}}{\textbf{\examnum}}{\textbf{Due: Feb. 25\\ beginning of class}}
\runningheadrule

\newcommand{\class}{Econ 5253}
\newcommand{\term}{Spring 2021}
\newcommand{\examdate}{Due: February 25, 2021}
...
\begin{parts}
    \part Download the following file from within R, Python, or Julia: \url{"https://www.vizgr.org/historical-events/search.php?format=json&begin_date=00000101&end_date=20210219&lang=en"}

    This website lists historical events from Jan 1, 0000 until Feb 19, 2021.
