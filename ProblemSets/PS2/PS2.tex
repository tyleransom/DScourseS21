...
\pagestyle{head}
\firstpageheader{\textbf{\class\ - \term}}{\textbf{\examnum}}{\textbf{Due: Jan. 28\\ beginning of class}}
\runningheader{\textbf{\class\ - \term}}{\textbf{\examnum}}{\textbf{Due: Jan. 28\\ beginning of class}}
\runningheadrule

\newcommand{\class}{Econ 5253}
\newcommand{\term}{Spring 2020}
\newcommand{\examdate}{Due: January 28, 2020}
...
As with the previous proble set, you will submit this problem set by pushing the document to \emph{your} (private) fork of the class repository. You will put this and all other problem sets in the path \texttt{/DScourseS20/ProblemSets/PS2/} and name the file \texttt{PS2\_LastName.pdf}.
\begin{questions}
...
\begin{enumerate}
	...
	\item Type \texttt{git clone https://github.com/[your-github-username]/DScourseS20.git}
	\item Check that everything works by typing \texttt{ls} and hitting enter. You should see a directory called ``DScourseS20'' and if you change to that directory, you should see an identical directory and file structure to what is on your GitHub private fork of the course repo.
\end{enumerate}
...
\begin{itemize}
	\item \texttt{cd \~}
	\item \texttt{cd DScourseS20/ProblemSets}
