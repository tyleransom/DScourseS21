...
\pagestyle{head}
\firstpageheader{\textbf{\class\ - \term}}{\textbf{\examnum}}{\textbf{Due: Feb. 9\\ beginning of class}}
\runningheader{\textbf{\class\ - \term}}{\textbf{\examnum}}{\textbf{Due: Feb. 9\\ beginning of class}}
\runningheadrule

\newcommand{\class}{Econ 5253}
\newcommand{\term}{Spring 2021}
\newcommand{\examdate}{Due: February 9, 2021}
...
\begin{itemize}
	\item \texttt{cd \~}
    \item \texttt{cd DScourseS21/ProblemSets/PS2} (note: you may need to create the \texttt{PS2} directory if it doesn't exist)
